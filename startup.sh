...
echo -e "To view live logs for the backend services, run: ${YELLOW}docker compose logs -f wallet-backend${NC}"
echo -e "To view live logs for the frontend services, run: ${YELLOW}docker compose logs -f wallet-frontend${NC}"
echo -e "To view live logs for the database services, run: ${YELLOW}docker compose logs -f wallet-mysql${NC}"
echo -e "To view live logs for the RabbitMQ services, run: ${YELLOW}docker compose logs -f wallet-rabbitmq${NC}"
